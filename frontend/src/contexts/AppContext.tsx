...
// Import your types
import { AppState, AppAction, Post } from '../types/appstate.type'; // Adjust the import path as needed
...
// Reducer function (same as you provided)
function appReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    return {
      ...state,
      groupList : listGroups().then(e => e.map(a = > a))
    }
    default:
      return state;
  }
